          ...
          >
            <div className="p-6 rounded-2xl bg-muted/50 border border-border">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-medium mb-1">Oblasť služieb</h4>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Pokrývame širšiu metropolitnú oblasť v okruhu 30 km. Nie ste si istí, či ste v dosahu? Stačí sa
                    opýtať!
                  </p>
                </div>
              </div>
            ...
            <div className="p-6 rounded-2xl bg-muted/50 border border-border">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-medium mb-1">Čas odpovede</h4>
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Zvyčajne odpovedáme do 2–4 hodín počas pracovných hodín. Väčšinu termínov vieme dohodnúť do 48
                    hodín.
                  </p>
                </div>
              </div>
